...
RemindersHandler = CommandHandler(['reminders', 'myreminders'], reminders, filters = Filters.group)
...
ClearAllRemindersHandler = CommandHandler(
    ...
    'clearallreminders', clear_all_reminders, filters = Filters.group)

ClearALLMyRemindersHandler = CommandHandler(

    ['clearmyreminders', 'clearallmyreminders'], clear_all_my_reminders, filters = Filters.group)
